      ...
      steps: [
        {
          ...
          voice: "Everything starts from this menu — Dashboard, Inventory, Insight List, Tickets, a section per asset, Task and Visualisation.",
        },
        {
          ...
          voice: "Dashboard opens on Total Water Management; the page selector, granularity and time range drive every widget.",
        },
        {
          ...
          voice: "Plant Flow traces every drop — inlet, U F, R O permeate and reject — and scores compliance per site.",
        },
        {
          ...
          voice: "Plant Efficiency puts every site on the same gauge, with the energy behind it underneath.",
        },
        {
          ...
          voice: "Water Quantity shows live tank levels per site, anything out of range in colour.",
        },
        {
          ...
          voice: "Aeration Health plots dissolved oxygen against its two to four p p m band.",
        },
        {
          ...
          voice: "Communications collects every alert Doctor Paani sent — WhatsApp, S M S, call and email.",
        },
        {
          ...
          voice: "Insight List does the watching — open alarms, closed ones, each explaining itself in plain language.",
        },
        {
          ...
          voice: "Visualisation holds a Scada View per site — blowers, tanks, D O and flow, live.",
        },
        {
          ...
          voice: "Group Control switches a group between Auto and Remote, then runs its twelve equipments individually.",
        },
        {
          ...
          voice: "Task List turns findings into work, each with a priority, an assignee, a method and photos.",
        },
        {
          ...
          voice: "Inventory tracks chemicals store by store — stock, last consumption, actual against expected.",
        },
        {
          ...
          voice: "Profile carries your name, phone verification and language. Pick Hindi, then save.",
        },
        {
          ...
          voice: "And the pages follow. Logbook Data Input reads a photo of the paper logbook with O C R.",
        },
        {
          ...
          voice: "Menu, widgets and pages, all in Hindi. One platform, every site, in your team's language.",
        },
      ],
    },
    hi: {
      ...
      steps: [
        {
          ...
          voice: "सब कुछ इसी मेन्यू से — डैशबोर्ड, इन्वेंटरी, इनसाइट लिस्ट, टिकट, हर एसेट का सेक्शन, टास्क और विज़ुअलाइज़ेशन।",
        },
        {
          ...
          voice: "डैशबोर्ड टोटल वॉटर मैनेजमेंट पर खुलता है; पेज सिलेक्टर, ग्रैन्युलैरिटी और समय सीमा हर विजेट चलाते हैं।",
        },
        {
          ...
          voice: "प्लांट फ्लो हर बूँद का रास्ता दिखाता है — इनलेट, यू एफ, आर ओ परमीट और रिजेक्ट — अनुपालन हर साइट का।",
        },
        {
          ...
          voice: "प्लांट दक्षता हर साइट को एक ही गेज पर रखती है, नीचे उसके पीछे की ऊर्जा।",
        },
        {
          ...
          voice: "जल मात्रा हर साइट के लाइव टैंक लेवल दिखाती है, रेंज से बाहर सब रंग में।",
        },
        {
          ...
          voice: "एरेशन हेल्थ घुलित ऑक्सीजन को दो से चार पी पी एम बैंड के सामने दिखाती है।",
        },
        {
          ...
          voice: "कम्युनिकेशंस डॉक्टर पानी के भेजे हर अलर्ट को जमा करता है — व्हाट्सएप, एस एम एस, कॉल और ईमेल।",
        },
        {
          ...
          voice: "इनसाइट लिस्ट निगरानी करती है — खुले अलार्म, बंद अलार्म, हर एक सरल भाषा में खुद समझाता है।",
        },
        {
          ...
          voice: "विज़ुअलाइज़ेशन में हर साइट का स्काडा व्यू है — ब्लोअर, टैंक, डी ओ और फ्लो, लाइव।",
        },
        {
          ...
          voice: "ग्रुप कंट्रोल ग्रुप को ऑटो और रिमोट के बीच बदलता है, फिर उसके बारह उपकरण अलग-अलग चलाता है।",
        },
        {
          ...
          voice: "टास्क लिस्ट निष्कर्षों को काम में बदलती है — हर टास्क पर प्राथमिकता, असाइनी, तरीका और फ़ोटो।",
        },
        {
          ...
          voice: "इन्वेंटरी हर स्टोर के केमिकल पर नज़र रखती है — स्टॉक, पिछली खपत, वास्तविक बनाम अपेक्षित।",
        },
        {
          ...
          voice: "प्रोफ़ाइल में नाम, फ़ोन सत्यापन और भाषा है। हिंदी चुनें, फिर सेव करें।",
        },
        {
          ...
          voice: "और पेज तुरंत बदल जाते हैं। लॉगबुक डेटा इनपुट काग़ज़ी लॉगबुक की फ़ोटो ओ सी आर से पढ़ता है।",
        },
        {
          ...
          voice: "मेन्यू, विजेट और पेज, सब हिंदी में। एक प्लेटफ़ॉर्म, हर साइट, आपकी टीम की भाषा में।",
        },
      ],
    },
    ta: {
      ...
      steps: [
        {
          ...
          voice: "எல்லாம் இந்த மெனுவிலிருந்தே — டாஷ்போர்டு, இன்வென்டரி, இன்சைட் லிஸ்ட், டிக்கெட், ஒவ்வொரு சொத்துக்கும் ஒரு பிரிவு, டாஸ்க், விஷுவலைசேஷன்.",
        },
        {
          ...
          voice: "டாஷ்போர்டு டோட்டல் வாட்டர் மேனேஜ்மென்ட்டில் திறக்கிறது; பக்கத் தேர்வி, நுணுக்கம், கால வரம்பு ஒவ்வொரு விட்ஜெட்டையும் இயக்குகின்றன.",
        },
        {
          ...
          voice: "பிளாண்ட் ஃப்ளோ ஒவ்வொரு துளியையும் காட்டுகிறது — இன்லெட், யு எஃப், ஆர் ஓ பெர்மியேட், ரிஜெக்ட் — இணக்கம் தளம் வாரியாக.",
        },
        {
          ...
          voice: "பிளாண்ட் எஃபிஷியன்சி ஒவ்வொரு தளத்தையும் ஒரே கேஜில் வைக்கிறது, கீழே அதன் ஆற்றல் நுகர்வு.",
        },
        {
          ...
          voice: "நீர் அளவு தளம் வாரியாகத் தொட்டி நிலைகளைக் காட்டுகிறது; வரம்புக்கு வெளியே உள்ளவை நிறத்தில்.",
        },
        {
          ...
          voice: "ஏரேஷன் ஹெல்த் கரைந்த ஆக்சிஜனை இரண்டு முதல் நான்கு பி பி எம் வரம்புக்கு எதிராகக் காட்டுகிறது.",
        },
        {
          ...
          voice: "கம்யூனிகேஷன்ஸ் டாக்டர் பானி அனுப்பிய ஒவ்வொரு எச்சரிக்கையையும் சேர்க்கிறது — வாட்ஸ்அப், எஸ் எம் எஸ், கால், மெயில்.",
        },
        {
          ...
          voice: "இன்சைட் லிஸ்ட் கண்காணிக்கிறது — திறந்த அலாரங்கள், மூடியவை, ஒவ்வொன்றும் எளிய மொழியில் விளக்குகிறது.",
        },
        {
          ...
          voice: "விஷுவலைசேஷனில் ஒவ்வொரு தளத்திற்கும் ஸ்காடா வியூ — பிளோயர், தொட்டி, டி ஓ, ஓட்டம், நேரலையில்.",
        },
        {
          ...
          voice: "குரூப் கன்ட்ரோல் குழுவை ஆட்டோ, ரிமோட் இடையே மாற்றி, பன்னிரண்டு உபகரணங்களைத் தனித்தனியாக இயக்குகிறது.",
        },
        {
          ...
          voice: "டாஸ்க் லிஸ்ட் கண்டுபிடிப்புகளை வேலையாக்குகிறது — முன்னுரிமை, ஒப்படைப்பு, முறை, புகைப்படத்துடன்.",
        },
        {
          ...
          voice: "இன்வென்டரி ஸ்டோர் வாரியாக வேதிப்பொருட்களைக் கண்காணிக்கிறது — கையிருப்பு, கடைசி நுகர்வு, உண்மை vs எதிர்பார்ப்பு.",
        },
        {
          ...
          voice: "சுயவிவரத்தில் பெயர், தொலைபேசி சரிபார்ப்பு, மொழி உள்ளன. இந்தியைத் தேர்ந்து சேமியுங்கள்.",
        },
        {
          ...
          voice: "பக்கங்கள் உடனே மாறுகின்றன. லாக்புக் டேட்டா இன்புட் காகிதப் புகைப்படத்தை ஓ சி ஆர் மூலம் படிக்கிறது.",
        },
        {
          ...
          voice: "மெனு, விட்ஜெட், பக்கங்கள், எல்லாம் இந்தியில். ஒரே தளம், ஒவ்வொரு இடமும், உங்கள் குழுவின் மொழியில்.",
        },
      ],
    },
    mr: {
      ...
      steps: [
        {
          ...
          voice: "सर्व काही याच मेनूपासून — डॅशबोर्ड, इन्व्हेंटरी, इनसाइट लिस्ट, तिकिटे, प्रत्येक अ‍ॅसेटचा विभाग, टास्क आणि व्हिज्युअलायझेशन.",
        },
        {
          ...
          voice: "डॅशबोर्ड टोटल वॉटर मॅनेजमेंटवर उघडतो; पेज सिलेक्टर, ग्रॅन्युलॅरिटी आणि वेळ श्रेणी प्रत्येक विजेट चालवतात.",
        },
        {
          ...
          voice: "प्लांट फ्लो प्रत्येक थेंबाचा मार्ग दाखवतो — इनलेट, यू एफ, आर ओ परमीट व रिजेक्ट — अनुपालन प्रत्येक साइटचे.",
        },
        {
          ...
          voice: "प्लांट कार्यक्षमता प्रत्येक साइट एकाच गेजवर ठेवते, खाली त्यामागचा ऊर्जा वापर.",
        },
        {
          ...
          voice: "पाण्याचे प्रमाण प्रत्येक साइटच्या टाकी पातळ्या दाखवते, श्रेणीबाहेरचे सर्व रंगात.",
        },
        {
          ...
          voice: "एरेशन हेल्थ विरघळलेला ऑक्सिजन दोन ते चार पी पी एम बँडसमोर दाखवते.",
        },
        {
          ...
          voice: "कम्युनिकेशन्स डॉक्टर पानीने पाठवलेला प्रत्येक अलर्ट एकत्र करते — व्हॉट्सअ‍ॅप, एस एम एस, कॉल आणि ईमेल.",
        },
        {
          ...
          voice: "इनसाइट लिस्ट लक्ष ठेवते — खुले अलार्म, बंद अलार्म, प्रत्येक सोप्या भाषेत स्वतः समजावते.",
        },
        {
          ...
          voice: "व्हिज्युअलायझेशनमध्ये प्रत्येक साइटचा स्काडा व्ह्यू — ब्लोअर, टाक्या, डी ओ आणि फ्लो, लाइव्ह.",
        },
        {
          ...
          voice: "ग्रुप कंट्रोल ग्रुप ऑटो आणि रिमोटमध्ये बदलतो, मग त्याची बारा उपकरणे स्वतंत्रपणे चालवतो.",
        },
        {
          ...
          voice: "टास्क लिस्ट निष्कर्षांचे काम करते — प्रत्येक टास्कवर प्राधान्य, असाइनी, पद्धत व फोटो.",
        },
        {
          ...
          voice: "इन्व्हेंटरी स्टोअरनुसार केमिकल्सचा मागोवा घेते — स्टॉक, शेवटचा वापर, प्रत्यक्ष विरुद्ध अपेक्षित.",
        },
        {
          ...
          voice: "प्रोफाइलमध्ये नाव, फोन पडताळणी आणि भाषा आहे. हिंदी निवडा, मग सेव्ह करा.",
        },
        {
          ...
          voice: "आणि पेजेस लगेच बदलतात. लॉगबुक डेटा इनपुट कागदी लॉगबुकचा फोटो ओ सी आर ने वाचतो.",
        },
        {
          ...
          voice: "मेनू, विजेट आणि पेजेस, सर्व हिंदीत. एक प्लॅटफॉर्म, प्रत्येक साइट, तुमच्या टीमच्या भाषेत.",
        },
      ],
    },
  },
